...
describe('mobile UI/UX audit contracts', () => {
  ...
  it('uses shared overflow and dialog footer controls on multi-action surfaces', () => {
    ...
    expect(readView('EquipmentView')).toContain('EquipmentCatalogList')
    expect(readComponent('equipment/EquipmentCatalogList')).toContain('AppActionOverflow')
    expect(readComponent('equipment/EquipmentOrderDialog')).toContain('AppDialogFooter')
