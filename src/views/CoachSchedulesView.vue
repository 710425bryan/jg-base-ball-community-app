...
import CoachScheduleEventSummary from '@/components/coach-schedules/CoachScheduleEventSummary.vue'
      ...
      <section v-else class="grid gap-3">
        ...
        >
          <div class="grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
            <CoachScheduleEventSummary :event="event" :assigned-coach-names="getAssignedCoachNames(event)" />
