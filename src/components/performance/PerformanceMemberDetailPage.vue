        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          >
            <template #before>
              <button
                type="button"
                class="inline-flex min-h-11 items-center gap-2 rounded-xl border border-gray-200 px-3 py-2 text-sm font-bold text-gray-600 hover:border-primary hover:text-primary transition-colors"
                      ...
                      <td class="px-5 py-4">
                        <div class="flex justify-end gap-2">
                          ...
                          <button
                            v-if="canDelete"
                            type="button"
                            class="inline-flex min-h-11 items-center gap-1.5 rounded-xl border border-red-100 bg-red-50 px-3 py-2 text-sm font-bold text-red-500 hover:bg-red-100 transition-colors"
