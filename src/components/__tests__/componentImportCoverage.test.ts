...
const componentImports = [
  ...
  { name: 'EquipmentPaymentSubmissionInbox', load: () => import('../equipment/EquipmentPaymentSubmissionInbox.vue') },
  ...
  { name: 'EquipmentRequestReviewPanel', load: () => import('../equipment/EquipmentRequestReviewPanel.vue') },
