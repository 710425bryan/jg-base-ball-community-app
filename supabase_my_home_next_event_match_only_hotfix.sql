...
-- Hotfix: MyHome "Next Up" is a schedule card. Keep attendance/roll-call state
-- in the dedicated dashboard attendance panel instead of mixing it into next_event.
