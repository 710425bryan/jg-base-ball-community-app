...
comment on column public.team_members.school_name
is 'School currently attended by the member. Values are manually maintained from the roster UI and reused as dropdown options.';
